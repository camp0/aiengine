...
public:
	...
	static const int header_size = 20;
    	...
    	inline u_int32_t getIPPacketLength() const { return ntohs(ip_header_->tot_len); }
    	...
    	inline u_int32_t getIPPayloadLength() const { return getIPPacketLength() - getIPHeaderLength(); }
