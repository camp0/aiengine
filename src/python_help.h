...
const char *help_flow_ip_set = 			"Returns the IPSet Info of the flow if the flow is part of an IPSet."; 
const char *help_flow_http_info =		"Returns the HTTP Info of the flow if the flow is HTTP."; 
const char *help_flow_sip_info =		"Returns the SIP Info of the flow if the flow is SIP.";	
const char *help_flow_smtp_info = 		"Gets the SMTP Info of the flow if the flow is SMTP.";	
const char *help_flow_pop_info = 		"Gets the POP Info of the flow if the flow is POP.";	
const char *help_flow_imap_info = 		"Gets the IMAP Info of the flow if the flow is IMAP.";	
...
const char *help_http_info_uri =		"Gets the HTTP URI of the flow if the flow is HTTP.";
const char *help_http_info_host_name =		"Gets the HTTP Host of the flow if the flow is HTTP."; 
const char *help_http_info_user_agent =		"Gets the HTTP UserAgent of the flow if the flow is HTTP."; 
...
const char *help_sip_info_uri =			"Gets the SIP URI of the flow if the flow is SIP."; 
const char *help_sip_info_from_name =		"Gets the SIP From of the flow if the flow is SIP."; 
const char *help_sip_info_to_name =		"Gets the SIP To of the flow if the flow is SIP."; 
const char *help_sip_info_via = 		"Gets the SIP Via of the flow if the flow is SIP."; 

const char *help_smtp_info_mail_from =		"Gets the Mail From of the flow if the flow is SMTP."; 
const char *help_smtp_info_mail_to = 		"Gets the Rcpt To of the flow if the flow is SMTP."; 
...
const char *help_ssdp_info_uri = 		"Gets the SSDP URI of the flow if the flow is SSDP."; 
const char *help_ssdp_info_host_name = 		"Gets the SSDP Host of the flow if the flow is SSDP.";

const char *help_frequencies_dispersion =	""; 
const char *help_frequencies_enthropy =		"";  
