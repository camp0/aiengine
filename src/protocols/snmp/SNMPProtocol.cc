...
boost::python::dict SNMPProtocol::getCounters() const {
	...
	counters["get reqs"] = total_snmp_get_requests_;
	counters["get next reqs"] = total_snmp_get_next_requests_;
	counters["get resp"] = total_snmp_get_responses_;
	counters["set req"] = total_snmp_set_requests_;
